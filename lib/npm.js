...
function load (npm, cli, cb) {
  which(process.argv[0], function (er, node) {
    ...
    var builtin = path.resolve(__dirname, "..", "edprc")
...
function loadPrefix (npm, conf, cb) {
  // try to guess at a good lib location.
  var p
    , gp
...
Object.defineProperty(npm, "dir",
  { get : function () {
      ...
      return path.resolve(npm.prefix, "lib")
    }
  , enumerable : true
  })
...
Object.defineProperty(npm, "globalDir",
  { get : function () {
      return (process.platform !== "win32")
           ? path.resolve(npm.globalPrefix, "lib", "lib")
           : path.resolve(npm.globalPrefix, "lib")
    }
  , enumerable : true
  })
