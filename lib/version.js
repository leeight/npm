...
version.usage = "edp version [<newversion> | major | minor | patch | build]\n"
              + "\n(run in package dir)\n"
              + "'edp -v' or 'edp --version' to print edp version "
              + "("+npm.version+")\n"
              + "'edp view <pkg> version' to view a package's "
              + "published version\n"
              + "'edp ls' to inspect current package/dependency versions"
