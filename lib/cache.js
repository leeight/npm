...
cache.usage = "edp cache add <tarball file>"
            + "\nedp cache add <folder>"
            + "\nedp cache add <tarball url>"
            + "\nedp cache add <git url>"
            + "\nedp cache add <name>@<version>"
            + "\nedp cache ls [<path>]"
            + "\nedp cache clean [<pkg>[@<version>]]"
...
// edp cache add <tarball-url>
// edp cache add <pkg> <ver>
// edp cache add <tarball>
// edp cache add <folder>
...
// folder.
//
// cache.add('foo@bar', '/path/lib/foo', cb)
//
