...
var cacheExtra = process.platform === "win32" ? "edp-cache" : ".edp"
...
Object.defineProperty(exports, "defaults", {get: function () {
  ...
  return defaults =
    ...
    , global : false
    , globalconfig : path.resolve(globalPrefix, "etc", "edprc")
    , globalignorefile : path.resolve( globalPrefix, "etc", "edpignore")
    ...
    , "user-agent" : "node/" + process.version
                     ...
                     + ' ' + process.arch
    , "rebuild-bundle" : true
    , registry : "http://cq01-sdc-ma01.vm.baidu.com:8453/"
    , rollback : true
    , save : false
    , "save-bundle": false
    , "save-dev" : false
    ...
    , username : ""
    , userconfig : path.resolve(home, ".edprc")
    , userignorefile : path.resolve(home, ".edpignore")
    , umask: 022
    , version : false
    , versions : false
